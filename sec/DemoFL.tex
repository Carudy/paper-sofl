In this section, we introduce the attack model and the detailed design of the proposed framework Democratic Federated Learning. At first definitions of some symbols are listed below:
\begin{itemize}
