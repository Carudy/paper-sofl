...
The learning method is based on FedAvg algorithm\cite{mcmahan2016communicationefficient}. A secure multi-party addition protocol is used to realize privacy-preserving. There are $N_l$ leaders in the system. W.l.o.g, we suppose $N_l = 3$. The process of secret sharing is illustrated as below:
